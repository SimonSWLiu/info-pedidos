...
CREATE TABLE IF NOT EXISTS `members` (
  ...
  `type_tag` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '收费类型，0：订餐；1：外卖费',
  PRIMARY KEY (`mid`),
...
INSERT INTO `members` (`mid`, `email`, `pwd`, `name`, `status`, `level`, `balance`, `ordering_count`, `delivery_count`, `delivery_ratio`, `type_tag`) VALUES
(1, 'benson.chen@infothinker.com', '21232f297a57a5a743894a0e4a801fc3', 'admin', 0, 1, 80, 0, 0, 1, 0),
(2, 'benson.rc86@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'benson', 0, 3, 46.3, 0, 0, 1, 0),
(3, 'test1@mail.com', '21232f297a57a5a743894a0e4a801fc3', 'test1', 0, 3, 64, 0, 0, 1, 0);
...
(7, 2, 1297417127, 2011, 2, 15, 10, 10, 1, '大西豪', 1, '套餐', 3, '老娘叉烧套餐', 19, 1, 19, '', 0),
(8, 1, 1297417505, 2011, 2, 16, 10, 45, 2, '华辉', 7, '饭', 7, '梅菜肉饼饭', 11, 1, 11, '', 1),
(9, 2, 1297417639, 2011, 2, 16, 11, 29, 2, '华辉', 7, '饭', 7, '梅菜肉饼饭', 11, 1, 11, '', 1),
(10, 2, 1297865686, 2011, 2, 16, 22, 14, 2, '华辉', 0, '', 0, '', 1, 1, 1, '外卖费', 1),
(11, 1, 1297869094, 2011, 2, 16, 23, 11, 2, '华辉', 0, '', 0, '', 0.5, 1, 0.5, '外卖费', 1),
(12, 2, 1297869094, 2011, 2, 24, 10, 11, 2, '华辉', 0, '', 0, '', 0.5, 1, 0.5, '外卖费', 1),
(13, 1, 1297947078, 2011, 3, 3, 10, 59, 1, '大西豪', 1, '套餐', 3, '老娘叉烧套餐', 19, 1, 19, '65477', 0),
(14, 3, 1298901360, 2011, 3, 3, 10, 56, 1, '大西豪', 1, '套餐', 3, '老娘叉烧套餐', 19, 1, 20, '1蚊额外附加', 1),
(15, 3, 1298901482, 2011, 3, 3, 21, 58, 1, '大西豪', 0, '', 0, '', 2, 1, 2, '外卖费', 1),
(16, 1, 1299081520, 2011, 3, 7, 11, 28, 2, '华辉', 7, '饭', 7, '梅菜肉饼饭', 11, 1, 11, '', 0),
(17, 1, 1299081520, 2011, 3, 7, 11, 28, 1, '大西豪', 6, '粥粉', 1, '玉燕饺米线', 15, 1, 15, '', 0),
(18, 3, 1299081594, 2011, 3, 7, 10, 59, 1, '大西豪', 6, '粥粉', 1, '玉燕饺米线', 15, 1, 15, '', 0);
